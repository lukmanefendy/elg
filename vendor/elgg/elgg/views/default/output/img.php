...
if ($vars['vrf'] != ''){
	...
	echo "<canvas $attributes width ='40' height='40'></canvas>";
	...
	if ($vars['class'] == "vsmall")
		$canvclass = '
					   ...
					   var canvas = document.getElementsByClassName("vsmall");
					   var context = canvas[0].getContext("2d");';

	//if ($vars['class'] == "vsmall")
	//	$canvclass = 'var canvas = document.getElementsByClassName("vsmall")';
	else if ($vars['class'] == "photo u-photo")
		$canvclass = '
						<script>
						window.onload = function () {
						var img1 = document.getElementsByClassName("img1");
						var img2 = document.getElementsByClassName("img2");
						var canvas = document.getElementsByClassName("u-photo");
						var context = canvas[0].getContext("2d");';
