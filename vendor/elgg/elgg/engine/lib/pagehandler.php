...
//ditambahkan:front untuk fungsi rekomen, kriteria, area, dan cara front page
function elgg_front_page_handler_rekomen() {
	return elgg_ok_response(elgg_view_resource('rekomen'));
}
function elgg_front_page_handler_kriteria() {
	return elgg_ok_response(elgg_view_resource('kriteria'));
}
function elgg_front_page_handler_area() {
	return elgg_ok_response(elgg_view_resource('area'));
}
function elgg_front_page_handler_cara() {
	return elgg_ok_response(elgg_view_resource('cara'));
}
 ...
 * @access private
 */
//ditambahkan:front untuk registrasi fungsi front page handler
function _elgg_page_handler_init() {
	elgg_register_page_handler('', 'elgg_front_page_handler');
	elgg_register_page_handler('rekomen', 'elgg_front_page_handler_rekomen');
	elgg_register_page_handler('kriteria', 'elgg_front_page_handler_kriteria');
	elgg_register_page_handler('area', 'elgg_front_page_handler_area');
	elgg_register_page_handler('cara', 'elgg_front_page_handler_cara');
}
