...
function elgg_profile_fields_setup() {
	global $CONFIG;
	//ditambahkan:type tampilan form 0405 10:10, 19:30
	$profile_defaults = array (
		...
		'alamat' => 'text',
		'jnspegawainama' => 'text',
		'kedudukanpnsnama' => 'text',
		'statuspegawai' => 'text',
		'jenisKelamin' => 'text',
		'jenisiddokumennama' => 'text',
		//'noSeriKarpeg' => 'text',
		'tkPendidikanTerakhir' => 'text',
		'pendidikanTerakhirNama' => 'text',
		'tahunLulus' => 'text',
		//'tmtpns' => 'text', 
		//'tglskpns' => 'text',
		//'tmtcpns' => 'text',
		//'tglskcpns' => 'text',
		'latihanstrukturalnama' => 'text', 
		'instansiIndukNama' => 'text',
		'satuanKerjaIndukNama' => 'text',
		'instansiKerjaNama' => 'text',
		'satuanKerjaKerjaNama' => 'text',
		'unorNama' => 'text',
		'unorIndukNama' => 'text',
		'jenisJabatan' => 'text',
		'jabatanNama' => 'text',
		'jabatanStrukturalNama' => 'text',
		'tmtJabatan' => 'text',
		'lokasiKerja' => 'text',
		//'golRuangAwal' => 'text',
		//'golRuangAkhir' => 'text',
		...
		// 'nomorSkPns' => 'text',
		'jabatanAsn' => 'text',
		'tkPendidikanNamaSd' => 'text',
		'tglLulusSd' => 'text',
		'namaSekolahSd' => 'text',
		'tkPendidikanNamaSmp' => 'text',
		'tglLulusSmp' => 'text',
		'namaSekolahSmp' => 'text',
		'tkPendidikanNamaSma' => 'text',
		'tglLulusSma' => 'text',
		'namaSekolahSma' => 'text',
		'tkPendidikanNamaS1' => 'text',
		'tglLulusS1' => 'text',
		'namaSekolahS1' => 'text',
		'tkPendidikanNamaS2' => 'text',
		'tglLulusS2' => 'text',
		'namaSekolahS2' => 'text',
		'tkPendidikanNamaS3' => 'text',
		'tglLulusS3' => 'text',
		'namaSekolahS3' => 'text',
		'kursus' => 'longtext',
		'jabatan' => 'longtext',
...
function users_init() {
	...
	//ditambah pagehandlers untuk regopt
	elgg_register_page_handler('webserv', 'elgg_user_account_page_handler');
	elgg_register_page_handler('regopt', 'elgg_user_account_page_handler');
	...
	elgg_register_plugin_hook_handler('regopt', 'menu:user_hover', 'elgg_user_hover_menu');
	elgg_register_plugin_hook_handler('webserv', 'menu:user_hover', 'elgg_user_hover_menu');

	elgg_register_action('regopt', '', 'public');
	elgg_register_action('register', '', 'public');
	elgg_register_action('webserv', '', 'public');
	...
	elgg_register_plugin_hook_handler('regopt', 'menu:entity', 'elgg_users_setup_entity_menu', 501);
	elgg_register_plugin_hook_handler('register', 'menu:entity', 'elgg_users_setup_entity_menu', 501);
	elgg_register_plugin_hook_handler('webserv', 'menu:entity', 'elgg_users_setup_entity_menu', 501);
