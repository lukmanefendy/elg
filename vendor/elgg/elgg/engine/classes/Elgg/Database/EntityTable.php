...
class EntityTable {
	...
	public function getEntities(array $options = array()) {
		...
		//ditambahkan:instansi untuk syarat where dalam sql
		if(isset($options['instansi'])){
			$wheres[] = "(st.instansi = '{$options['instansi']}')";
			//$wheres[] = $this->getGuidBasedWhereSql('e.instansi', $options['instansi']);			
		}
