...
$admin_links = '';
//ditambahkan:focal filter utk menutup admin option menu 
$user_admin = elgg_get_logged_in_user_entity();
if (elgg_is_admin_logged_in() && elgg_get_logged_in_user_guid() != elgg_get_page_owner_guid() && $user_admin->focal == 'no') {
